...
@registry.envcfg("Go2JoystickRoughFull")
@dataclass
class Go2JoystickRoughFullCfg(Go2JoystickCfg):
...
class Go2JoystickRoughFullDomainRandomizationProvider(Go2JoystickDomainRandomizationProvider):
...
@registry.env("Go2JoystickRoughFull", sim_backend="mujoco")
class Go2JoystickRoughFullEnv(Go2WalkTask):
    _cfg: Go2JoystickRoughFullCfg
    _reward_cfg: RoughRewardConfig

    def __init__(self, cfg: Go2JoystickRoughFullCfg, num_envs=1, backend_type="mujoco"):
        ...
        self._dr_manager = DomainRandomizationManager(
            self, Go2JoystickRoughFullDomainRandomizationProvider()
        )
    ...
    def _terrain_out_of_bounds(self) -> np.ndarray:
        terrain_cfg = self._cfg.terrain_generator
